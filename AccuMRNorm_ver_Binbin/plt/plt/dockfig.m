function fig = dockfig(POS,TITLE,titlecolor,titlesize,varargin)
%DOCKFIG - modified figure() command w/ other defaults...
% DOCKFIG(POS,TITLE,TITLECOLOR,TITLESIZE,...)
% DOCKFIG(POS,TITLE,TITLECOLOR,TITLESIZE,'PropertyName',PropertyValue,...)
%
% NKL, 9.05.02
