function [out1,out2,out3] = myginput(arg1,CurType)
...
%
% [X,Y] = MYGINPUT gathers an unlimited number of points until the
% return key is pressed.
% 
% [X,Y,BUTTON] = MYGINPUT(N) returns a third result, BUTTON, that 
