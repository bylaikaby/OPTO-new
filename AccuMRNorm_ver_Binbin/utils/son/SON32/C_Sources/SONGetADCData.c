...
% calls, this can be faster but it breaks normal MATLAB conventions. Note
% that, if the memory is shared with another variable because of MATLAB's 
% lazy-copy memory management, the values placed in data will also be shared.
%
