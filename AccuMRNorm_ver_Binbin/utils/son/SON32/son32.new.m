...
%SON32 Create structures to define interfaces found in 'Son4matlab_loadlibrary'.

%This function was generated by loadlibrary.m parser version 1.1.6.22 on Wed Mar  3 15:42:10 2010
%perl options:'Son4matlab_loadlibrary.i -outfile=son32.m'
...
fcns.name{fcnNum}='SONLastTime'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int16', 'uint16', 'int32', 'int32', 'voidPtr', 'int8PtrPtr', 'int16Ptr', 'TFilterMaskPtr'};fcnNum=fcnNum+1;
...
% double WINAPI SONFileSizeD ( short fh ); 
fcns.name{fcnNum}='SONFileSizeD'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='double'; fcns.RHS{fcnNum}={'int16'};fcnNum=fcnNum+1;
% double WINAPI SONChanBytesD ( short fh , WORD chan ); 
fcns.name{fcnNum}='SONChanBytesD'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='double'; fcns.RHS{fcnNum}={'int16', 'uint16'};fcnNum=fcnNum+1;
% short WINAPI SONCreateFileEx ( TpCStr name , int nChannels , WORD extra , int iBigFile ); 
fcns.name{fcnNum}='SONCreateFileEx'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='int16'; fcns.RHS{fcnNum}={'string', 'int32', 'uint16', 'int32'};fcnNum=fcnNum+1;
% int WINAPI SONIsBigFile ( short fh ); 
fcns.name{fcnNum}='SONIsBigFile'; fcns.calltype{fcnNum}='stdcall'; fcns.LHS{fcnNum}='int32'; fcns.RHS{fcnNum}={'int16'};fcnNum=fcnNum+1;
