...
#ifndef _INCLUDE_DF_H
#define _INCLUDE_DF_H
...
enum DATA_TYPE {
  ...
  DF_FLAG, DF_CHAR, DF_INT32, DF_SHORT, DF_FLOAT, DF_STRUCTURE, 
  DF_STRING, DF_INT32_ARRAY, DF_SHORT_ARRAY, DF_FLOAT_ARRAY,
  DF_STRING_ARRAY, DF_LIST, DF_VOID, DF_VOID_ARRAY, DF_CHAR_ARRAY, 
  DF_LIST_ARRAY
};
// backward compatibility...
#define DF_LONG  DF_INT32
#define DF_LONG_ARRAY DF_INT32_ARRAY
...
enum STRUCT_TYPE {
  TOP_LEVEL,			/* regular data type (e.g. int32, float)*/
  DATA_FILE_STRUCT, 
  DF_INFO_STRUCT, 
  OBS_P_STRUCT, 
  OBS_INFO_STRUCT, 
...
typedef struct {
  ...
  int32_t time;			/* seconds since Jan. 1, 1970, 00:00   */
...
typedef struct {
  ...
  int32_t date_time;                  /* date/time cell was isolated       */
...
void dfRecordInt32(unsigned char, int32_t);
#define dfRecordLong(a,b)  dfRecordInt32(a,b)
...
void dfRecordInt32Array(unsigned char, int, int32_t *);
#define dfRecordLongArray(a,b,c)  dfRecordInt32Array(a,b,c)
...
DYN_LIST *dfuResetDynListToType(DYN_LIST *, int, int);
...
void dfuAddDynListInt32(DYN_LIST *, int32_t);
#define dfuAddDynListLong(a,b)  dfuAddDynListInt32(a,b)
...
void dfuPrependDynListInt32(DYN_LIST *, int32_t);
#define dfuPrependDynListLong(a,b)  dfuPrependDynListInt32(a,b)
...
int dfuInsertDynListInt32(DYN_LIST *, int32_t, int pos);
#define dfuInsertDynListLong(a,b,c)  dfuInsertDynListInt32(a,b,c)
