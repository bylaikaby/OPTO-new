 ...
 *  ver 1.12  27-Aug-2013  YM  adc2volts as double, supports int32-Ai.
 *
 *
 * NOTE :            win     linux    OSX
 ...
 *     xxx:      double*  adc2volts [nchannels_ai + nchannels_di];  // scaling value from adc to volts
 *
 * DATA
...
typedef struct _adfx_header { 
    ...
    double  *adc2volts;          // scaling value from adc to volts
