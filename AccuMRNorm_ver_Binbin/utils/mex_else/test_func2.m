...
% compute distance
% run pdist
metric = 'mi';   % euclid, seuclid, cityblock, mahal, minkowski
metric = 'euclid';   % euclid, seuclid, cityblock, mahal, minkowski
...
return;
% get linkage
method = 'wa';   % single, complete, average, centroid, ward
