...
switch lower(eventdata),
 ...
 case {'redraw'}
  ...
  set(wgts.LightboxAxs,'xlim',[0 nX*NRow],'ylim',[0 nY*NCol]);
 ...
 case {'button'}
  ...
  if strcmpi(click,'open'),
    ...
    subZoomInLightbox(iDimension,[NCol NRow],SLICES,wgts,ANA);
  end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SUBFUNCTION to zoom-in plot
function subZoomInLightbox(iDimension,NColNRow,SLICES,wgts,ANA)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
