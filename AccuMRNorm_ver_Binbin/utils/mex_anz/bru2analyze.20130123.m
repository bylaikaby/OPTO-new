...
if nargout,
  ...
  subWriteInfo(SAVEDIR,froot,HDR,...
             TDSEQFILE,RECOSZ,[xres,yres,zres],EXPORT_AS_2D,SPLIT_IN_TIME,DO_AVERAGE,IMGCROP,SLICROP,PERMUTE_V,FLIPDIM_V);
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function subWriteInfo(SAVEDIR,froot,HDR,TDSEQFILE,RECOSZ,XYZRES,EXPORT_AS_2D,SPLIT_IN_TIME,DO_AVERAGE,IMGCROP,SLICROP,PERMUTE_V,FLIPDIM_V)
...
fprintf(fid,'permute:  [');
if ~isempty(PERMUTE_V),  fprintf(fid,' %d',PERMUTE_V);  end
fprintf(fid,' ]\n');
fprintf(fid,'flipdim:  [');
if ~isempty(FLIPDIM_V),  fprintf(fid,' %d',FLIPDIM_V);  end
fprintf(fid,' ]\n');
