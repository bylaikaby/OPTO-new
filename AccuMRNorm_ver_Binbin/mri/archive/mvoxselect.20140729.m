...
%
%  See also mview mdiffmap mvoxlogical mvoxresponse dspmvox dspmvoxmap dspmvoxtc FDR_thres
...
[MAP TC] = subGetData(Ses,grp,anap,SIG,MODEL,TRIAL,ALPHA,RoiName,DO_CLUSTER,...
                      SELECT_CORR,MIN_SNR,FDR_Q,VERBOSE);
...
function [STATMAP TC] = subGetData(Ses,grp,anap,ROITS,MODEL,TRIAL,ALPHA, RoiName, DO_CLUSTER, SELECT_CORR, MIN_SNR, FDR_Q, VERBOSE)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
switch lower(MODEL),
 case { 'glm' }
  STATMAP = subGetStatGLM(anap,ROITS,ALPHA,ModelNo,'statv',VERBOSE);
 case { 'cor', 'corr' }
  STATMAP = subGetStatCorr(anap,ROITS,ALPHA,ModelNo,SELECT_CORR);
 case { 'none', 'null' }
...
function STATMAP = subGetStatCorr(anap,ROITS,alpha,ModelNo,SELECT_CORR)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
STATMAP = {};
EPIDIM = size(ROITS{1}{1}.ana);
DATNAME = 'r';
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SUBFUNCTION to generate statistical data correlation analysis
function STATMAP = subGetStatGLM(anap,ROITS,alpha,ModelNo,DATNAME,VERBOSE)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
STATMAP = {};
EPIDIM = size(ROITS{1}{1}.ana);
