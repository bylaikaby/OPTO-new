...
%    0.91 17.10.12 YM  "York" works when .ds differs.
%    0.92 06.12.13 YM  supports "move to the current SRC".
%    0.93 09.12.13 YM  supports more action commands (copy/paste etc).
%    0.94 29.05.14 YM  supports more transformation types.
%    0.95 22.04.16 YM  fixed problem on graphics handles (2014b).
%
...
uicontrol(...
    ...
    'String',{'nonreflective similarity','similarity','linear conformal','affine','projective','polynomial','piecewise linear','lwm'},...
    'Value',8,...
