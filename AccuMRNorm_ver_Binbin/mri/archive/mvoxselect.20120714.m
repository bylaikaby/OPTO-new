...
%    SNR          : minimum SNR
%    FDRQ         : q value for False-Discovery-Rate
%
%  EXAMPLE :
...
[MAP TC] = subGetData(Ses,GRPEXP,MODEL,TRIAL,ALPHA,RoiName,DO_CLUSTER,...
                      SIG,SIGNAME,SELECT_CORR,MIN_SNR,VERBOSE);
...
if any(FDR_Q)
  ...
  ROITS.stat.fdr_p = FDR_thres(ROITS.stat.p,FDR_Q);
end
...
function [STATMAP TC] = subGetData(Ses,GRPEXP,MODEL,TRIAL,ALPHA, RoiName, DO_CLUSTER, ROITS, SIGNAME, SELECT_CORR, MIN_SNR, VERBOSE)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
