...
AtlasSetCmb = uicontrol(...
    ...
    'String',{'Rat : Paxinos' 'Rhesus : Saleem' 'Rhesus : CoCoMac/mod'},...
    'Value',1,...
...
GROI{end+1} =  {'Ass', 'Association Cortex',      [.8 .5 1],...
                {'AI','AID','AIP','AIV','DI','GI','RSA','RSGa','RSGb','FrA','DP','IL', ...
                 'PrL','PtA','TeA','DLO','LO','MO','VO'}};
...
GROI{end+1} =  {'BG',  'Basal Ganglia',           [.5 .8 1],...
                {'CPu','LGP','VP','VTA','PBP','PN','SN','SNCD','SNL','SNM','SNR','SNRDM', ...
                 'SNRVL'}};
...
GROI{end+1} =  {'Lmb', 'Limbic System',           [.6 .6 0],...
                {'amyg','AA','AAD','AAV','Aco','AHiAL','AHiPM','APir',...
                 ...
                 'Pir/ext','Pir/int','Pir','PirCtx','Cg1','Cg2','df','f','Ld','LSD',...
                 'LSI','LSV','MS','PLd','SFi','SHi','SL','TS',...
...
GROI{end+1} =  {'ME',  'Mesencephalic System',    [0.1 0.1 0.1],...
                {'DLPAG','DMPAG','LPAG','PAG','Su3','Su3C','VLPAG',...
                 'DpMe','APT','IMLF','IMLFG','m1','PaR','REth','RMC','RPC',...   
                 'lfp','Pn','PnO','RtTg','RtTgP','tfp','CLi','DR','DRC','DRV','DRVL', ...
                 'PMnR','RLi','MnR'}};
return
