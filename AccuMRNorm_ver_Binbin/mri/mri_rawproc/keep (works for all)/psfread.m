function im = psfread(ppath,file,psferrfac)
...
% YM  19.06.2018, MPI Tübingen:  bug fix
...
for n = 0 : nc - 1
    fprintf('%s...', num2str(n));
    junk{n + 1} = epireadfid(ppath, file, n, p, a, psferrfac);
end
k = cat(5,junk{:});
fprintf('\n');
...
%%
function k = epireadfid(ppath, file, ch, p, a, psferrfac)
