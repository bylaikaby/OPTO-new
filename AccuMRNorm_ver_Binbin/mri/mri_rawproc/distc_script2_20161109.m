...
[~, psf] = fidcopyreadnew_20171024('/opt/PV6.0/data/guest/20161102_085012_K13_1_22/37/','fidCopy_EG'); %ANPASSEN!!20161102_085012_K13_1_22
...
%     fid = fopen('2dseq_orig','r');
    ...
    epi = OLD_phcorr_segm(epi,'nMVM',60);
