...
DEF.sesdir    = '//wks8/mridata/M02.lx1';
DEF.fscan     = '7';
DEF.sesdir    = '//wks6/data/D04.LG1';
DEF.fscan     = '14';
if nargin > 0 && ischar(varargin{1}),
  switch lower(varargin{1})
   case {'4.7t','47t'}
    DEF.sesdir = '//wks19/mridata/';
    DEF.fscan  = '10';
   case {'7t','7'}
    DEF.sesdir = '//wks4/data/';
    DEF.sesdir = '//wks24/data/';
    DEF.fscan  = '10';
  end
end
...
if evalin('base','exist(''SIG'',''var'')'),
  ...
  if isfield(SIG,'path') && isfield(SIG,'session')
    DEF.sesdir = fullfile(SIG.path,SIG.session);
  end
...
uicontrol(...
    ...
    'String',DEF.sesdir,'Tag','SesDirEdt',...
    'HorizontalAlignment','left',...
...
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[XDSP H-0.3 30 1.5],...
    'String','Functional','FontWeight','bold',...
    'HorizontalAlignment','left',...
    'Tag','FuncScanTxt',...
    'BackgroundColor',get(hMain,'Color'));
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[XDSP+12 H-0.3 30 1.5],...
...
uicontrol(...
    'Parent',hMain,'Style','Edit',...
    'Units','char','Position',[XDSP+20 H 7 1.5],...
    'Callback','monline(''Main_Callback'',gcbo,''set-scanreco'',guidata(gcbo))',...
...
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[XDSP+24 H-0.3 30 1.5],...
    'String','Trial4Avr:','FontWeight','bold',...
    'HorizontalAlignment','left',...
    'Tag','StimTrialTxt',...
    'BackgroundColor',get(hMain,'Color'));
uicontrol(...
...
uicontrol(...
    'Parent',hMain,'Style','Checkbox',...
    'Units','char','Position',[XDSP+28 H 20 1.5],...
    'Tag','ApplyHRFCheck','Value',DEF.apply_hrf,...
    'Callback','monline(''Main_Callback'',gcbo,''set-anap'',guidata(gcbo))',...
    'String','Apply HRF','FontWeight','bold',...
    'TooltipString','Apply HRF','BackgroundColor',get(hMain,'Color'));
...
switch lower(eventdata),
 case {'init'}
  Main_Callback(wgts.SesDirEdt,'set-scanreco',[]);
  Main_Callback(wgts.SesDirEdt,'set-stimulus',[]);
  Main_Callback(wgts.SesDirEdt,'set-anap',[]);

 case {'set-scanreco'}
  sesdir = get(wgts.SesDirEdt,'String');
 ...
 case {'view-tripilot'}
  ...
  if ischar(APPDATA.imgfile),
    monlinetripilot(APPDATA.trifile,APPDATA.imgfile,'hfig',gcf+100);
  else
    monlinetripilot(APPDATA.trifile,APPDATA.imgfile{1},'hfig',gcf+100);
  end
