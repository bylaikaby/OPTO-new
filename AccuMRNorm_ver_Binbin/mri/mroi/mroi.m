...
%    1.44 24.10.12 YM  supports 'clear bitmaps for all slices' action.
%    1.45 15.02.13 YM  creates a new bitmap by 'add bitmaps'.
%    1.46 31.05.13 YM  clean-up duplicated ROIs by mroi_clean().
%    1.50 27.09.13 YM  supports shift/scale.
%    1.51 07.10.13 YM  use tcImg.anascale for EpiAna.
%    1.52 28.02.14 YM  supports rotate.
%    1.53 18.07.18 YM  bug fix when .imgcrop is empty.
%    1.54 21.11.19 YM  clean-up
%
%  See also hroi mroisct mroidsp mroi_cursor mroi_file mroi_save mroi_clean mroi_shift
...
if ischar(SESSION) && any(strfind(SESSION,'Callback'))
  if nargout
...
uicontrol(...
    ...
    'Units','char','Position',[IMGXOFS+38 H 25 1.5],...
    'String',{'Grp 1','Grp 2'},...
...
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[IMGXOFS H-2 12 1.25],...
    'String','ROI Set : ','FontWeight','bold',...
    'HorizontalAlignment','left','fontsize',9,...
    'BackgroundColor',BKGCOL);
uicontrol(...
    'Parent',hMain,'Style','popupmenu',...
    'Units','char','Position',[IMGXOFS+11 H-1.75 25 1.25],...
    'String',{'Roi 1','Roi 2'},...
...
uicontrol(...
    'Parent',hMain,'Style','PushButton',...
    'Units','char','Position',[IMGXOFS+38 H-2 16 1.5],...
...
uicontrol(...
    'Parent',hMain,'Style','PushButton',...
    'Units','char','Position',[IMGXOFS+55 H-2 16 1.5],...
...
% ====================================================================
XDSP = IMG2XOFS;  HY = figH - 4;
% Gamma setting to displaying anatomy
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[XDSP-11 HY 30 1.25],...
    'String','Anatomy: ','FontWeight','bold',...
    'HorizontalAlignment','left','fontsize',9,...
    'BackgroundColor',BKGCOL);
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[XDSP+1 HY 30 1.25],...
    'String','Gamma: ','FontWeight','bold',...
    'HorizontalAlignment','left','fontsize',9,...
    'BackgroundColor',BKGCOL);
uicontrol(...
    'Parent',hMain,'Style','Edit',...
    'Units','char','Position',[XDSP+12 HY 10 1.5],...
...
uicontrol(...
    ...
    'Units','char','Position',[XDSP+23 HY 25 1.5],...
...
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[XDSP+34 HY 30 1.25],...
    'String','Scale: ','FontWeight','bold',...
    'HorizontalAlignment','left','fontsize',9,...
    'BackgroundColor',BKGCOL);
uicontrol(...
    'Parent',hMain,'Style','Edit',...
    'Units','char','Position',[XDSP+42 HY 20 1.5],...
    'Callback','mroi(''Main_Callback'',gcbo,''imgdraw'',[])',...
...
uicontrol(...
    'Parent',hMain,'Style','Checkbox',...
    'Units','char','Position',[XDSP+62.5 HY 25 1.5],...
...
% ====================================================================
XDSP = IMGXOFS;
H = figH-6;%IMGYOFS + IMGYLEN + 0.6;
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[XDSP H 12 1.25],...
    'String','Pointer : ','FontWeight','bold',...
    'HorizontalAlignment','left','fontsize',9,...
    'BackgroundColor',BKGCOL);
uicontrol(...
    'Parent',hMain,'Style','popupmenu',...
    'Units','char','Position',[XDSP+11 H 25 1.5],...
...
uicontrol(...
    'Parent',hMain,'Style','Checkbox',...
    'Units','char','Position',[XDSP+38 H-0.15 12 1.5],...
    'Tag','Sticky','Value',0,...
...
ActCmd = {'No Action','Find','UNDO','Coordinate','Append','Replace',...
          ...
          'Clear electrodes',...
          'Clear Bitmap', 'Clear All Slices (Bitmap)','Clear All Slices (ALL Bitmaps)',...
...
% uicontrol(...
%     'Parent',hMain,'Style','Text',...
%     'Units','char','Position',[XDSP+46 H 12 1.25],...
%     'String','Marker : ','FontWeight','bold',...
%     'HorizontalAlignment','left','fontsize',9,...
%     'BackgroundColor',BKGCOL);
uicontrol(...
    'Parent',hMain,'Style','Checkbox',...
    'Units','char','Position',[XDSP+56 H-0.15 12 1.5],...
...
uicontrol(...
    'Parent',hMain,'Style','popupmenu',...
    'Units','char','Position',[XDSP+60 H 25 1.5],...
    'String',MarkerCmd,...
...
% rotate/shift/scale
XDSP = IMG2XOFS;
ShiftScaleCmd = {'Rotate/Shift/Scale','UNDO',...
                 'current ROI',...
                 'all ROIs',...
                };
uicontrol(...
    'Parent',hMain,'Style','popupmenu',...
    'Units','char','Position',[XDSP+1 H 27 1.5],...
    'String',ShiftScaleCmd,...
    'Callback','mroi(''RoiShiftScale_Callback'',gcbo,''roi-shiftscale'',[])',...
    'TooltipString','Shift/Scale action',...
    'Tag','RoiShiftScaleCmb','FontWeight','Bold');
uicontrol(...
    'Parent',hMain,'Style','Edit',...
    'Units','char','Position',[XDSP+29 H 10 1.5],...
    'String','0','Tag','RoiRotateEdt',...
    'HorizontalAlignment','center',...
    'TooltipString','XY Rotate in degrees (+:cw -:ccw)',...
    'FontWeight','bold','BackgroundColor','white');
uicontrol(...
    'Parent',hMain,'Style','Edit',...
    'Units','char','Position',[XDSP+40 H 15 1.5],...
    'String','0   0','Tag','RoiShiftEdt',...
    'HorizontalAlignment','center',...
    'TooltipString','XY Shift in EPI pixel',...
    'FontWeight','bold','BackgroundColor','white');
uicontrol(...
    'Parent',hMain,'Style','Edit',...
    'Units','char','Position',[XDSP+56 H 15 1.5],...
    'String','1   1','Tag','RoiScaleEdt',...
    'HorizontalAlignment','center',...
    'TooltipString','XY Scale',...
    'FontWeight','bold','BackgroundColor','white');
...
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[XDSP+48 figH-12.5 12 1.25],...
    'String','DrawROI: ','FontWeight','bold',...
    'HorizontalAlignment','left','fontsize',9,...
    'foregroundcolor',[0.8 0.8 0],'BackgroundColor',[0 0 .2]);
uicontrol(...
    'Parent',hMain,'Style','popupmenu',...
    'Units','char','Position',[XDSP+60 figH-12.5 25 1.5],...
...
uicontrol(...
    'Parent',hMain,'Style','popupmenu',...
    'Units','char','Position',[IMG2XOFS+1 figH-12.5 25 1.5],...
    'Callback','mroi(''Main_Callback'',gcbo,''roidraw-epi'',[])',...
    'Tag','RoiDrawEpiCmb','Value',2,...
    'String',{'ana-link' 'all' 'all ROIs' 'all polygons' 'current' 'markers' 'none'},'FontWeight','bold',...
    'TooltipString','Draw ROI-polygon');

% dot size for ROI(bitmap)
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[IMG2XOFS+28 figH-12.5 20 1.25],...
    'String','BmpDot: ','FontWeight','bold',...
    'HorizontalAlignment','left','fontsize',9,...
    'foregroundcolor',[0.8 0.8 0],'BackgroundColor',[0 0 .2]);
uicontrol(...
    'Parent',hMain,'Style','Edit',...
    'Units','char','Position',[IMG2XOFS+39 figH-12.5 10 1.5],...
    'Callback','mroi(''Main_Callback'',gcbo,''redraw'',[])',...
    'String','1.5','Tag','BitmapDotEdt',...
    'HorizontalAlignment','left',...
    'TooltipString','set bitmap''s dot-size',...
    'FontWeight','bold');
...
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[XDSP-14 HY 12 1.25],...
    'String','Stat Map: ','FontWeight','bold',...
    'HorizontalAlignment','left','fontsize',9,...
    'BackgroundColor',BKGCOL);
uicontrol(...
    'Parent',hMain,'Style','popupmenu',...
    'Units','char','Position',[XDSP-2 HY 25 1.5],...
    'String',{'none'},...
    'Callback','mroi(''Main_Callback'',gcbo,''imgdraw'',[])',...
...
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[XDSP+25 HY 12 1.25],...
    'String','V-Thr: ','FontWeight','bold',...
    'HorizontalAlignment','left','fontsize',9,...
    'BackgroundColor',BKGCOL);
uicontrol(...
    'Parent',hMain,'Style','Edit',...
    'Units','char','Position',[XDSP+33 HY 10 1.5],...
...
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[XDSP+45 HY 12 1.25],...
    'String','P-Thr: ','FontWeight','bold',...
    'HorizontalAlignment','left','fontsize',9,...
    'BackgroundColor',BKGCOL);
uicontrol(...
    'Parent',hMain,'Style','Edit',...
    'Units','char','Position',[XDSP+53 HY 12 1.5],...
    'Callback','mroi(''Main_Callback'',gcbo,''imgdraw'',guidata(gcbo))',...
...
uicontrol(...
    'Parent',hMain,'Style','Checkbox',...
    'Units','char','Position',[XDSP+67 HY 30 1.5],...
    'Callback','mroi(''Main_Callback'',gcbo,''imgdraw'',guidata(gcbo))',...
...
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[IMG2XOFS+59 figH-12.5 18 1.25],...
...
uicontrol(...
    'Parent',hMain,'Style','Checkbox',...
    'Units','char','Position',[XDSP+38 H-0.15 20 1.5],...
    'Callback','mroi(''Main_Callback'',gcbo,''imgdraw'',[])',...
...
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[XDSP+52.5 H 6 1.25],...
    'String','slice: ','FontWeight','bold',...
    'HorizontalAlignment','left','fontsize',9,...
    'BackgroundColor',BKGCOL);
uicontrol(...
    'Parent',hMain,'Style','Edit',...
    'Units','char','Position',[XDSP+60 H 8 1.5],...
    'Callback','mroi(''Main_Callback'',gcbo,''edit-atlslice'',[])',...
    'String','','Tag','AtlasSlice',...
    'HorizontalAlignment','left',...
    'TooltipString','Atlas slice',...
    'FontWeight','bold','BackgroundColor','white');
uicontrol(...
    'Parent',hMain,'Style','slider',...
    'Units','char','Position',[XDSP+69 H 25 1.5],...
...
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[XDSP+98 H 30 1.25],...
    'String','crop (mm): ','FontWeight','bold',...
    'HorizontalAlignment','left','fontsize',9,...
    'BackgroundColor',BKGCOL);
uicontrol(...
    'Parent',hMain,'Style','Edit',...
    'Units','char','Position',[XDSP+112, H 25 1.5],...
...
uicontrol(...
    'Parent',hMain,'Style','pushbutton',...
    'Units','char','Position',[XDSP+138, H 12 1.5],...
...
uicontrol(...
    'Parent',hMain,'Style','Text',...
    'Units','char','Position',[XDSP+IMG2XOFS+63 H 15 1.25],...
    'String','rotate:','FontWeight','bold',...
    'HorizontalAlignment','left','fontsize',9,...
    'BackgroundColor',BKGCOL);
uicontrol(...
    'Parent',hMain,'Style','Edit',...
    'Units','char','Position',[XDSP+IMG2XOFS+72, H 10 1.5],...
    'Callback','mroi(''Main_Callback'',gcbo,''imgdraw'',[])',...
...
switch lower(eventdata)
 case {'init'}
  ...
  tcImg.anascale = [0 max(tcImg.ana(:))*0.8];
  ...
  if anap.ImgDistort == 0 && isfield(grp,'ana') && ~isempty(grp.ana)
    if length(ses.ascan.(grp.ana{1})) >= grp.ana{2}
      tmpanainf = ses.ascan.(grp.ana{1}){grp.ana{2}};
      if isfield(tmpanainf,'imgcrop') && ~isempty(tmpanainf.imgcrop)
...
if strcmpi(get(wgts.AtlasSliceBarSldr,'Enable'),'on')
 ...
 case {'roidraw-ana'}
  ...
  if strcmpi(RoiDraw,'ana-link')
    Main_Callback(hObject,'roidraw-epi',handles);
  end
 ...
 case {'load'}
  ...
  if exist(RoiFile,'file') && ~isempty(who('-file',RoiFile,RoiVar))
    ...
    Roi = mroi_clean(Roi);  % clean-up duplicated ROIs.
 ...
 case {'save'}
  ...
  %   save(RoiFile,RoiVar);
  % end
  set(wgts.StatusField,'String',sprintf('Saving "%s" to "%s"...  DONE.',RoiVar,RoiFile));
 ...
 case {'imgproc-select'}
  ...
  switch lower(imgpro)
   ...
   otherwise
    set(wgts.StatusField,'String',sprintf('imgproc(%s) not supported.',imgpro));
    return
  end 
...
switch lower(COMMANDSTR)
 case {'append'}
  ...
  while 1
    ...
    % old but keep for the compatibility:
    RoiRoi{N}.px    = anapx * IMGDIMS.pxscale;
    RoiRoi{N}.py    = anapy * IMGDIMS.pyscale;
    % new more preceise but may lose the compatibility
    % RoiRoi{N}.px    = (anapx-0.5) * IMGDIMS.pxscale + 0.5;
    % RoiRoi{N}.py    = (anapy-0.5) * IMGDIMS.pyscale + 0.5;
    % fprintf('anapx[%g %g] anapy[%g %g] --> px[%g %g] py[%g %g]\n',...
    %         min(anapx),max(anapx),min(anapy),max(anapy),...
    %         min(RoiRoi{N}.px),max(RoiRoi{N}.px),min(RoiRoi{N}.py),max(RoiRoi{N}.py));
 ...
 case {'add bitmap'}
  ...
  while 1
    ...
    % more precise...
    % RoiAdd{N}.px    = (anapx-0.5) * IMGDIMS.pxscale + 0.5; 
    % RoiAdd{N}.py    = (anapy-0.5) * IMGDIMS.pyscale + 0.5;
    if SAME_DIMS
  ...
  % create a new bitmap ROI
  if found == 0 && ~isempty(RoiAdd)
    tmproi = RoiAdd{1};
    tmproi.px = [];
    tmproi.py = [];
    for K = 1:length(RoiAdd)
      tmproi.mask = tmproi.mask | RoiAdd{K}.mask;
    end
    RoiRoi{end+1} = tmproi;
    clear tmproi;
  end
 ...
 case {'clear all slices (all bitmaps)'}
  % clear all bitmaps in all slices
  IDX = [];
  for N = 1:length(RoiRoi)
    if any(RoiRoi{N}.px)
      IDX(end+1) = N;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% CALLBACK for ROI-ACTION
function RoiShiftScale_Callback(hObject,eventdata,handles)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

if ~strcmpi(eventdata,'roi-shiftscale'), return;  end
...
wgts = guihandles(hObject);
if get(wgts.RoiShiftScaleCmb,'Value') == 1,  return;  end  % do nothing

actions = get(wgts.RoiShiftScaleCmb,'String');
COMMANDSTR = actions{get(wgts.RoiShiftScaleCmb,'Value')};

set(wgts.StatusField,'String',sprintf('ROI-shiftscale (''%s'')...',COMMANDSTR));

SLICE    = round(get(wgts.SliceBarSldr,'Value'));
XYROTATE = str2num(get(wgts.RoiRotateEdt,'String'));
XYSHIFT  = str2num(get(wgts.RoiShiftEdt,'String'));
XYSCALE  = str2num(get(wgts.RoiScaleEdt,'String'));

if isempty(XYROTATE),  XYROTATE = 0;      end
if isempty(XYSHIFT),   XYSHIFT  = [0 0];  end
if isempty(XYSCALE),   XYSCALE  = [1 1];  end

if XYROTATE == 0 && all(XYSHIFT == 0) && all(XYSCALE == 1)
  set(wgts.StatusField,'String','made no rotate/shift/scale');
  set(wgts.RoiShiftScaleCmb,'Value',1);
  return
end

% these are required for mroisct()
ses = getappdata(wgts.main,'Ses');
grp = getappdata(wgts.main,'Grp');
GAMMA  = str2double(get(wgts.GammaEdt,'String'));
tcImg  = getappdata(wgts.main,'tcImg');
...
% do backup
if ~strcmpi(COMMANDSTR,'undo')
  setappdata(wgts.main,'LastRoiAction','shift-scale');
  setappdata(wgts.main,'RoiRoi_bak',RoiRoi);
end
...
switch lower(COMMANDSTR)
 ...
 case {'current roi'}
  roiname = get(wgts.RoiSelCmb,'String');
  roiname = roiname{get(wgts.RoiSelCmb,'Value')};
  tmproiset = mroisct(ses,grp,tcImg,anaImg,GAMMA);
  tmproiset.roi = RoiRoi;
  tmproiset = mroi_shift(tmproiset,XYSHIFT,'slices',SLICE,...
                         'rotate',XYROTATE,'scale',XYSCALE,'roi',roiname,'save',0);
  RoiRoi = tmproiset.roi;
  setappdata(wgts.main,'RoiRoi',RoiRoi);
 case {'all rois'}
  roiname = 'all';
  tmproiset = mroisct(ses,grp,tcImg,anaImg,GAMMA);
...
for N = 1:length(Roi.roi)
  if ~isfield(Roi.roi{N},'mask') || ~any(Roi.roi{N}.mask(:) > 0)
    selidx(N) = NaN;
  end
end
...
if get(wgts.EpiAnaCheck,'value') > 0
  tcImg = getappdata(wgts.main,'tcImg');
  anasclstr = sprintf('%g %g',tcImg.anascale(1),tcImg.anascale(2));
  clear tcImg;
else
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% SUBFUNCTION to draw an image
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function sub_mroidsp(img,cbar,gamma)

if ~isa(img,'double'), img = double(img);  end

cmap = gray(256);
if any(gamma),  cmap = cmap.^(1/gamma);  end


img = round(img*256);
imgrgb = ind2rgb(img',gray(256));
imshow(imgrgb);
...
MarkerSize = str2double(get(wgts.BitmapDotEdt,'String'));
