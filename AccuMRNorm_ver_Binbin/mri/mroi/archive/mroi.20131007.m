...
% shift/scale
XDSP = IMG2XOFS;
ShiftScaleCmd = {'Shift/Scale','UNDO',...
                 'current ROI',...
                 'all ROIs',...
                };
RoiShiftScaleCmb = uicontrol(...
    'Parent',hMain,'Style','popupmenu',...
    'Units','char','Position',[XDSP+1 H 25 1.5],...
...
RoiShiftEdt = uicontrol(...
    'Parent',hMain,'Style','Edit',...
    'Units','char','Position',[XDSP+27 H 15 1.5],...
...
if all(XYSHIFT == 0) && all(XYSCALE == 1),
  set(wgts.StatusField,'String','made no shift/scale');
...
switch lower(COMMANDSTR),
 ...
 case {'current roi'}
  ...
  tmproiset = mroi_shift(tmproiset,XYSHIFT,'slices',SLICE,'scale',XYSCALE,'roi',roiname,'save',0);
