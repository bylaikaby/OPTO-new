...
ActCmd = {'No Action','Coordinate','Append','Replace','Electrodes',...
          ...
          'Clear Atlas', 'Clear All Slices (Atlas)',...
...
if isfield(anap,'mroi')
  ...
  if isfield(anap.mroi,'atlas') && ~isempty(anap.mroi.atlas),
    ...
    atlasfile=fullfile(fileparts(mfilename('fullpath')),'mroiatlas/atlas_data/atlas.mat'); %locate atlas
