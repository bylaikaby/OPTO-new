...
%    0.95 22.06.17 DB  fix a problem of PULPROG: '<mbepi.ppg>' where reco=x2slices.
%    0.96 02.11.17 YM  fix a problem of .res when RECO_transposition.
%
...
PVPAR.fov      = imgp.fov;
%PVPAR.res      = imgp.res;
PVPAR.res      = imgp.dimsize(1:2);  % taking into account of RECO_transposition
