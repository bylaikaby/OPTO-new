...
raw_dataset_dir = 'D:\OPTO_fMRI_CM\Raw_data\CM032.Aw1';
dataset_dir = 'D:\OPTO_fMRI_CM\BIDS_data\CM032_BIDS\sub-CM032';

analysis_dir = fullfile(dataset_dir,'first_level_analysis');
mkdir(analysis_dir)

% define the run ids to get the onset times.
mkdir(analysis_dir)
num_runs= [IDs.OPTO.Combined,IDs.MSTIM.Combined,67, 68, 69, 70, 71];
